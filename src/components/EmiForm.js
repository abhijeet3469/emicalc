...
import './EmiForm.css'
import EmiTableForm from './EmiTableForm.js'
import EmiResultForm from './EmiResultForm'
  ...
  return (
    <div className='maindiv'>
        {toggle?(
            ...
            <EmiTableForm emitable={emidates} goBack={() => goBack()} />
        )}
        ...
        {toggle && (
            <EmiResultForm list={previousData} emitable={emidates} />
        )}
    </div>
)
}
